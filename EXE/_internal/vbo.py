...
class ColiseoVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        ...
        try:
            objs = pywavefront.Wavefront(resource_path('objects/Coliseo/10064_colosseum_v1_Iteration0.obj'), cache=True, parse=True)
...
class EiffelVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        ...
        try:
            objs = pywavefront.Wavefront(resource_path('objects/Eiffel/10067_Eiffel_Tower_v1_max2010_it1.obj'), cache=True, parse=True)
            obj = objs.materials.popitem()[1]
            vertex_data = obj.vertices
            vertex_data = np.array(vertex_data, dtype='f4')
        except Exception as e:
...
class PisaTowerVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/pisatower/10076_pisa_tower_v1_max2009_it0.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
class CatedralVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/catedral/10086_saint_basil_cathedral_v1_L3.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class EstatuaVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/10085_egypt_sphinx_V2_L3.123cedbb80cc-eec4-4899-a587-d46dd8eff3b9/10085_egypt_sphinx_iterations-2.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class Estatua2VBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/Statue_v1_L2.123cc93d694a-81fb-4c81-8a75-7fa010dfa777/12330_Statue_v1_L2.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class bigbenVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/bigben/10059_big_ben_v2_max2011_it1.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class moaiVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/moai/10805_Moai_L3.mb.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class Pedestal_bigbenVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/Pedestal/10421_square_pedastal_iterations-2.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class Estatua3_AVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/Estatua_A/12328_Statue_v1_L2.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class Banco1_VBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/Banco/ConcreteBench-L3.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class Arbol1_VBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/Arbol/10446_Palm_Tree_v1_max2010_iteration-2.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data
...
class Castillo_VBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/castillo/13020_Aquarium_Castle_v1_L1.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data    
...
class Columpio_VBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/columpio/10549_ChildrenSwingSet_v1-LoD2.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data   
...
class Mujer_VBO(BaseVBO):
    ...
    def get_vertex_data(self):
        objs = pywavefront.Wavefront(resource_path('objects/mujer/10578_barbiedoll_v1_L3.obj'), cache=True, parse=True)
        obj = objs.materials.popitem()[1]
        vertex_data = obj.vertices
        vertex_data = np.array(vertex_data, dtype='f4')
        return vertex_data   
...
class museo3VBO(BaseVBO):
        ...
        def get_vertex_data(self):
            objs = pywavefront.Wavefront(resource_path('objects/Museos/Museo3/modelo_editado.obj'), cache=True, parse=True)
            obj = objs.materials.popitem()[1]
            vertex_data = obj.vertices
            vertex_data = np.array(vertex_data, dtype='f4')
            return vertex_data
...
class museo4VBO(BaseVBO):
        ...
        def get_vertex_data(self):
            objs = pywavefront.Wavefront(resource_path('objects/Museos/Museo4/modelo_editado.obj'), cache=True, parse=True)
            obj = objs.materials.popitem()[1]
            vertex_data = obj.vertices
            vertex_data = np.array(vertex_data, dtype='f4')
            return vertex_data