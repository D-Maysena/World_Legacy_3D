...
# Cargar el modelo 3D utilizando pywavefront con resource_path
modelo_path = resource_path('objects/Museos/Museo4/modelo_editado.obj')
objs = pywavefront.Wavefront(modelo_path, cache=True, parse=True)
...
# Trazar el segundo polígono si es necesario
