...
class Camera:
    # Para poder simular una cámara necesitamos determinar la matriz de vista como 
    ...
    def move(self):
        ...
        min_y = 0.0  # Altura mínima permitida
        max_y = 10.0  # Altura máxima permitida
    ...
    def get_projection_matrix(self):
        ...
        # La relación de aspecto que determina el campo de visión. Esta se determina dividiendo el ancho entre el alto
